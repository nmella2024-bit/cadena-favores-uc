...
const GlobalSearch = () => {
  ...
  return (
    <div ref={searchRef} className="relative w-full md:w-auto">
      ...
      <div className="hidden md:block relative md:w-32 lg:w-40 xl:w-48">
        ...
        <input
          ...
          placeholder="Buscar..."
          className="w-full pl-8 pr-9 py-1.5 bg-card border border-border rounded-lg text-text-primary placeholder:text-text-muted focus:outline-none focus:ring-2 focus:ring-brand/30 focus:border-brand transition-all text-sm"
        />
        {searchTerm && (
          <button
            onClick={handleClear}
            className="absolute right-2 top-1/2 -translate-y-1/2 p-0.5 hover:bg-canvas rounded transition-colors"
          >
