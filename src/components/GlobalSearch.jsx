...
const GlobalSearch = () => {
  ...
  return (
    <div ref={searchRef} className="relative w-full md:w-auto">
      ...
      <div className="hidden md:block relative md:w-24 lg:w-32">
      ...
      <button
        ...
        aria-label="Buscar"
      >
        <Search className="w-4 h-4 sm:w-5 sm:w-5" />
      </button>
      ...
      {isOpen && (
        <div className="md:hidden fixed inset-0 top-16 z-50 px-2 sm:px-3 animate-fadeIn overflow-y-auto">
          <div className="bg-card border border-border rounded-xl shadow-2xl overflow-hidden max-h-[calc(100vh-5rem)] w-full my-2">
            ...
            <div className="p-2 sm:p-3 border-b border-border bg-canvas sticky top-0 z-10">
              <div className="relative">
                <Search className="absolute left-2.5 sm:left-3 top-1/2 -translate-y-1/2 w-4 h-4 sm:w-5 sm:h-5 text-text-muted flex-shrink-0" />
                <input
                  type="text"
                  value={searchTerm}
                  ...
                  placeholder="Buscar..."
                  autoFocus
                  className="w-full pl-8 sm:pl-10 pr-16 sm:pr-20 py-2 sm:py-2.5 bg-card border border-border rounded-lg text-text-primary placeholder:text-text-muted focus:outline-none focus:ring-2 focus:ring-brand/30 focus:border-brand transition-colors text-sm"
                />
